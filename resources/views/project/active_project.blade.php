            ...
            @if(Auth::check())
                @if(Auth::user()->is('student'))
                    ...
                    @elseif(Auth::user()->isMemberOfProject())
                        ...
                        <p class="text-warning">{{trans('project.already_in_team_notification', ['nameet' => Auth::user()->isMemberOfProject()]['name_et'], ['nameen' => Auth::user()->isMemberOfProject()]['name_en'])}} <a href="{{url('project/'.Auth::user()->isMemberOfProject()['id'])}}"> <i class="fa fa-external-link"></i> </a></p>
