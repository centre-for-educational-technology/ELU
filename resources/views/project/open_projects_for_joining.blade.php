        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <h1>Ava liitumine projektidesse</h1>
                ...
                <div class="panel-body">
                    ...
                    <!-- New Project Form -->
                    <form action="{{ url('/admin/open-projects') }}" id="project-form" method="POST" class="form-horizontal new-project" enctype="multipart/form-data">
                    {{ csrf_field() }}
                        ...
                        <!-- Save changes -->
                        <div class="col-lg-12">
                            <br><button type="submit" id="open_projects_for_joining" class="btn btn-info btn-lg btn-block">Ava projektid</button>
                        </div>
