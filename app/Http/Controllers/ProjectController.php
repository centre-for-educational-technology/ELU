...
class ProjectController extends Controller
{
  ...
  */
  public function old_add(Request $request)
  {
...
/**
   * Update project info
   */
  public function update(NewProjectRequest $request, $id)
  {
    ...
    foreach ($cosupervisors as $cosupervisor){
	  ...
	  $project_cosupervisors_points = CosupervisorsPoints::where('new_project_id', $project->id)->get();
