        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <!-- New Project Form -->
                    <form action="{{ url('project/newV2')}}" id="project-form" method="POST" class="form-horizontal new-project" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="well well-sm">
                            ...
                            <div class="form-group">
                                <lable for="meetings_dates_text" class="col-sm-3 control-label">{{trans('project.meetings_dates')}}</lable>
                                <div id="metting_dates_fields" class="col-sm-6">
                                    <input type="date">
                                    <input type="text">
                                </div>
                                <button id="add_meeting_time">Lisa veel üks kohtumise aeg</button>
                                <input type="hidden" name="meetings_dates_text" id="meetings_dates_text" class="form-control">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select class="js-example-basic-multiple form-control" id="supervisors" name="supervisors[]" disabled>
                                    @if ($teachers->count())
